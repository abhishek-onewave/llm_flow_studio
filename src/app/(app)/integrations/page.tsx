...
const integrations: Integration[] = [
  {
    ...
    category: "Code",
    icon: GitBranch,
    iconColor: "bg-[#23251d] text-white",
    status: "connected",
  ...
  },
  {
    ...
    category: "Databases",
    icon: Database,
    iconColor: "bg-[#336791] text-white",
    status: "not_connected",
    permission: "Read-only default",
    permissionIcon: Eye,
  },
  {
    ...
    category: "Databases",
    icon: Zap,
    iconColor: "bg-[#3ecf8e] text-white",
    status: "not_connected",
  ...
  },
  {
    ...
    category: "Databases",
    icon: Database,
    iconColor: "bg-[#00758f] text-white",
    status: "not_connected",
    permission: "Read-only default",
    permissionIcon: Eye,
  },
  {
    ...
    category: "Databases",
    icon: Database,
    iconColor: "bg-[#4faa41] text-white",
    status: "not_connected",
    permission: "Read-only default",
    permissionIcon: Eye,
  },
  ...
  },
  {
    ...
    category: "APIs",
    icon: Code2,
    iconColor: "bg-[#6366f1] text-white",
    status: "not_connected",
    permission: "Custom",
  ...
  },
  {
    ...
    category: "Search",
    icon: Globe,
    iconColor: "bg-[#2c84e0] text-white",
    status: "connected",
  ...
  },
  {
    ...
    category: "Databases",
    icon: Database,
    iconColor: "bg-[#7c44a6] text-white",
    status: "not_connected",
    permission: "Read-only default",
    permissionIcon: Eye,
  },
  {
    ...
    category: "APIs",
    icon: MessageSquare,
    iconColor: "bg-[#611f69] text-white",
    status: "not_connected",
    permission: "Configurable",
    permissionIcon: Lock,
  },
